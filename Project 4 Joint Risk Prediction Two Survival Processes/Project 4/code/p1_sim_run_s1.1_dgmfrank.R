### Simulation file for scenario s1.1, frank copula DGM ###
...
save.image(paste("data/s1.1/sim_run_s1.1_dgmfrank_n", n.devel.sim, "v", n.valid.sim, "s", set.seed.sim, ".RData", sep = ""))

...
print("fit frailty normal")
Sys.time()
predrisk.frailty.normal <- calc.predrisk.frailty.parallel.5.init(data.devel = data.devel, 
                                                                 ...
                                                                 n.iter = 4000)
print("frailty normal fitted")
Sys.time()
save.image(paste("Project 4/data/clinical_example_fit_frailty_normal_model", model.type, "_n", data.size, ".RData", sep = ""))

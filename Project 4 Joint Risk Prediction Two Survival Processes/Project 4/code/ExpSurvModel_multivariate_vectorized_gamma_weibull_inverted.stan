...
model {
    ...
    target += weibull_lpdf(times_uncens_A | shape_A, exp(-log(omega[IDs_uncens_A]) - intercept_A - (X_uncens_A*betas_A)));
    target += weibull_lccdf(times_cens_A | shape_A, exp(-log(omega[IDs_cens_A]) - intercept_A - (X_cens_A*betas_A)));
    target += weibull_lpdf(times_uncens_B | shape_B, exp(-log(omega[IDs_uncens_B]) - intercept_B - (X_uncens_B*betas_B)));
    target += weibull_lccdf(times_cens_B | shape_B, exp(-log(omega[IDs_cens_B]) - intercept_B - (X_cens_B*betas_B)));

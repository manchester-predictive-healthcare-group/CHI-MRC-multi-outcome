### Simulation file for scenario s1.1, clayton copula DGM ###
...
save.image(paste("data/s1.2/sim_run_s1.2_dgmclay_n", n.devel.sim, "v", n.valid.sim, "s", set.seed.sim, ".RData", sep = ""))

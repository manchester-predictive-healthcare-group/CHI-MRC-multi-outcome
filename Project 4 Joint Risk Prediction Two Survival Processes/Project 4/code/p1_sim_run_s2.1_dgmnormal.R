### Simulation file for scenario s2.1, normal frailty DGM ###
...
save.image(paste("data/s2.1/sim_run_s2.1_dgmnormal_n", n.devel.sim, "v", n.valid.sim, "s", set.seed.sim, ".RData", sep = ""))

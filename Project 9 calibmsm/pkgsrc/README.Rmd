...
## Development version
You can install the development version of predRupdate from [GitHub](https://github.com/) with::
```{r, eval = FALSE}
...
## Getting help
If you encounter a bug, please file an issue with a minimal reproducible example on [GitHub](https://github.com/manchester-predictive-healthcare-group/CHI-MRC-multi-outcome/tree/main/Project%209%20calibmsm/pkgsrc).

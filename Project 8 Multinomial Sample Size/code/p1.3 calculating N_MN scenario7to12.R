...
n.req.MN.7 <- 10/((0.9-1)*log(1-(R2_ADJ.1/0.9)))
n.req.MN.8 <- 10/((0.9-1)*log(1-(R2_ADJ.2/0.9)))
n.req.MN.9 <- 10/((0.9-1)*log(1-(R2_ADJ.3/0.9)))
n.req.MN.10 <- 10/((0.9-1)*log(1-(R2_ADJ.4/0.9)))
n.req.MN.11 <- 10/((0.9-1)*log(1-(R2_ADJ.5/0.9)))
n.req.MN.12 <- 10/((0.9-1)*log(1-(R2_ADJ.6/0.9)))
...
rm(list=setdiff(ls(),list("n.req.MN.7", "n.req.MN.8", "n.req.MN.9", 
                          "n.req.MN.10", "n.req.MN.11", "n.req.MN.12")))

save.image("R_out/calculating N_MN scen 7to12.RData")

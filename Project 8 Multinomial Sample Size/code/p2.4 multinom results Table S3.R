...
## Load image
load("R_out/multinom simulation scen7to12 500000val.RData")


### Create lists of dataframes of the simulations output
scen1.dataframes <- vector("list", 5)
for (i in 1:5){scen1.dataframes[[i]] <- data.frame(scenario7.res[[(i)]])}

scen2.dataframes <- vector("list", 5)
for (i in 1:5){scen2.dataframes[[i]] <- data.frame(scenario8.res[[(i)]])}

scen3.dataframes <- vector("list", 5)
for (i in 1:5){scen3.dataframes[[i]] <- data.frame(scenario9.res[[(i)]])}

scen4.dataframes <- vector("list", 5)
for (i in 1:5){scen4.dataframes[[i]] <- data.frame(scenario10.res[[(i)]])}

scen5.dataframes <- vector("list", 5)
for (i in 1:5){scen5.dataframes[[i]] <- data.frame(scenario11.res[[(i)]])}

scen6.dataframes <- vector("list", 5)
for (i in 1:5){scen6.dataframes[[i]] <- data.frame(scenario12.res[[(i)]])}


### Give sample sizes as names to list elements
sample.sizes1 <- c(250,500,1000,177,196)
sample.sizes2 <- c(250,500,1000,189,219)
sample.sizes3 <- c(250,500,1000,186,198)
sample.sizes4 <- c(250,500,1000,209,289)
sample.sizes5 <- c(250,500,1000,233,455)
sample.sizes6 <- c(250,500,1000,470,505)
...
output.scen7.med <- get.output.tables.med(scen1.dataframes.S)
output.scen8.med <- get.output.tables.med(scen2.dataframes.S)
output.scen9.med <- get.output.tables.med(scen3.dataframes.S)
output.scen10.med <- get.output.tables.med(scen4.dataframes.S)
output.scen11.med <- get.output.tables.med(scen5.dataframes.S)
output.scen12.med <- get.output.tables.med(scen6.dataframes.S)

rm(list=setdiff(ls(), list("output.scen7.med","output.scen8.med",
                           "output.scen9.med","output.scen10.med",
                           "output.scen11.med","output.scen12.med")))

save.image("R_out/multinom results Table S3.RData")

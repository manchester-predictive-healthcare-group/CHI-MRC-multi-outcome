...
load(paste("data/ce_pv_prep_N", n.devel, "_npctls", n.pctls, ".RData", sep = ""))
...
### Save image
save.image(paste("data/ce_pv_calc_set_N", n.devel, "_S", state,"_npctls", n.pctls, "_pctl", pctl, "_set", set, ".RData", sep = ""))
...
for (set in 1:50){
  ...
  ### Load data
  load(paste("data/sim/small_sample_mean_analysis_", scen, "_n", n.cohort, "_npctls", n.pctls, "_set", set, ".RData", sep = ""))
...
save.image(paste("data/sim/small_sample_mean_analysis_", scen, "_n", n.cohort, "_npctls", n.pctls, ".RData", sep = ""))
print("IMAGE SAVED")